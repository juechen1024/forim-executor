"""Python adaptation of Java `ScheduleInnerJobClient`.

Method names now follow Java camelCase naming:
- createAsynchronousJob(ScheduleJobDTO) -> ScheduleJobDTO
- updateAsynchronousJob(ScheduleJobDTO) -> int
- getScheduleJobs(ScheduleJobDTO) -> List[ScheduleJobDTO]
- createScheduleJobLog(ScheduleJobLogDTO) -> ScheduleJobLogDTO
"""
...
class ScheduleInnerJobClient:
    ...
    def createAsynchronousJob(self, dto: ScheduleJobDTO) -> ScheduleJobDTO:
    ...
    def updateAsynchronousJob(self, dto: ScheduleJobDTO) -> int:
        ...
        raise RuntimeError('Unexpected response format for updateAsynchronousJob')

    def getScheduleJobs(self, dto: ScheduleJobDTO) -> List[ScheduleJobDTO]:
        ...
        raise RuntimeError('Unexpected response format for getScheduleJobs')

    def createScheduleJobLog(self, dto: ScheduleJobLogDTO) -> ScheduleJobLogDTO:
