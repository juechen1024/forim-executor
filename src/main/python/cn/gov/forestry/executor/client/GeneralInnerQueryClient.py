"""Python adaptation of Java `GeneralInnerQueryClient`.

Method names converted to Java camelCase:
- getSystemInfo(GeneralSystemDTO) -> GeneralSystemDTO
- queryUserInfoByToken(GeneralUserDTO) -> GeneralUserDTO
"""
...
class GeneralInnerQueryClient:
    ...
    def getSystemInfo(self, dto: GeneralSystemDTO) -> GeneralSystemDTO:  # Java-style
    ...
    def queryUserInfoByToken(self, dto: GeneralUserDTO) -> GeneralUserDTO:  # Java-style
