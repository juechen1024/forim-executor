"""Python adaptation of Java `MetadataInnerOptClient`.

Method names converted to Java camelCase:
- updateMetadataTableAdditionalProperties(MetadataTableDTO) -> MetadataTableDTO
- createField(MetadataFieldDTO) -> MetadataFieldDTO
- createFieldBatch(MetadataFieldBatchDTO) -> MetadataFieldBatchDTO
"""
...
class MetadataInnerOptClient:
    ...
    def updateMetadataTableAdditionalProperties(self, dto: MetadataTableDTO) -> MetadataTableDTO:
    ...
    def createField(self, dto: MetadataFieldDTO) -> MetadataFieldDTO:
    ...
    def createFieldBatch(self, dto: MetadataFieldBatchDTO) -> MetadataFieldBatchDTO:
